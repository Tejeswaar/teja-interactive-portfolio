...
function ProjectCard({
  ...
  return (
    ...
    >
      ...
      {/* Links */}
      <div className="flex gap-3 pt-2 border-t border-ctp-surface1/30 items-center justify-start flex-wrap">
        {project.github && (
          <a
            href={project.github}
            target="_blank"
        ...
        {project.playStore && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-xs font-mono text-ctp-teal hover:text-ctp-green transition-colors flex items-center gap-1"
          >
